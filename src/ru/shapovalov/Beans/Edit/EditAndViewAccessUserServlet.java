...
@Stateless
@WebServlet("/editAndViewAccessUserServlet")
    public class EditAndViewAccessUserServlet extends DispatcherServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        super.forward("/edit/editAndViewAccessUser.jsp", request, response);
    }
}
