...
@Stateless
@WebServlet("/editAndViewUserServlet")
    public class EditAndViewUserServlet extends DispatcherServlet {
//    Derive the base "editAndViewUser.jsp"
//    with a search on the basis of
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        super.forward("/edit/editAndViewUser.jsp", request, response);
    }
}
