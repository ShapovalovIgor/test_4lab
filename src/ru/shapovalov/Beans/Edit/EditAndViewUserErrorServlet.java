...
@Stateless
@WebServlet("/editAndViewUserErrorServlet")
    public class EditAndViewUserErrorServlet extends DispatcherServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        super.forward("/edit/editAndViewUserError.jsp", request, response);
    }
}
