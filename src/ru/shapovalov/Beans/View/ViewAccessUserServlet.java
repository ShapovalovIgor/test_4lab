...
@Stateless
@WebServlet("/viewAccessUserServlet")
    public class ViewAccessUserServlet extends DispatcherServlet {
//Obtain data on the level of user access and copy in the collection for future output "startPrivilegedUserPage.jsp"
// Just organize search by level of access
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        super.forward("/view/viewAccessUser.jsp", request, response);
    }
}
